...
#
# The trybuild `compile_fail` test is skipped: it builds its test cases in a child cargo/rustc
# process which Tarpaulin cannot instrument (and which exceeds its response timeout), yielding
# no coverage.
coverage:
